<template>
  <q-page class="q-pa-lg">
    <div class="container q-mx-auto" style="max-width: 800px">
      <div class="text-h4 text-weight-bold q-mb-lg">TERMS OF USE</div>
      <div class="text-subtitle1 q-mb-lg">Last updated March 2024</div>

      <div class="text-h5 text-weight-bold q-mb-md">AGREEMENT TO OUR LEGAL TERMS</div>

      <p class="q-mb-md">We are My Backyard USA ("Company," "we," "us," "our").</p>

      <p class="q-mb-md">
        We operate the My Backyard USA website and mobile application, as well as any other related
        products and services that refer or link to these legal terms (the "Legal Terms")
        (collectively, the "Services").
      </p>

      <p class="q-mb-md">
        You can contact us by email at support@mybackyardusa.com or by mail to My Backyard USA, 123
        Main Street, Suite 100, New York, NY 10001.
      </p>

      <p class="q-mb-md">
        These Legal Terms constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity ("you"), and My Backyard USA, concerning your access to
      ...
      <div class="text-h5 text-weight-bold q-mb-md">TABLE OF CONTENTS</div>
      <ol class="q-mb-xl">
        <li>OUR SERVICES</li>
      ...
      <div class="text-h5 text-weight-bold q-mb-md">1. OUR SERVICES</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">2. INTELLECTUAL PROPERTY RIGHTS</div>
      <p class="q-mb-md">Our intellectual property</p>
      <p class="q-mb-xl">
      ...
      <p class="q-mb-md">Your use of our Services</p>
      <p class="q-mb-xl">
        ...
        properly gained access, solely for your personal, non-commercial use or internal business
        purpose.
      </p>
      ...
      <p class="q-mb-xl">
        ...
        support@mybackyardusa.com. If we ever grant you the permission to post, reproduce, or
      ...
      <p class="q-mb-md">Your submissions</p>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">3. USER REPRESENTATIONS</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">4. PROHIBITED ACTIVITIES</div>
      <p class="q-mb-xl">
      ...
      <p class="q-mb-md">As a user of the Services, you agree not to:</p>
      <ul class="q-mb-xl">
        <li>
      ...
      <div class="text-h5 text-weight-bold q-mb-md">5. USER GENERATED CONTRIBUTIONS</div>
      <p class="q-mb-xl">
        ...
        by other users of the Services and through third-party websites. When you create or make
        available any Contributions, you thereby represent and warrant that:
      </p>

      <div class="text-h5 text-weight-bold q-mb-md">6. CONTRIBUTION LICENSE</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">7. SERVICES MANAGEMENT</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">8. TERM AND TERMINATION</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">9. MODIFICATIONS AND INTERRUPTIONS</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">10. GOVERNING LAW</div>
      <p class="q-mb-xl">
        These Legal Terms shall be governed by and defined following the laws of the United States.
        My Backyard USA and yourself irrevocably consent that the courts of the United States shall
        have exclusive jurisdiction to resolve any dispute which may arise in connection with these
        Legal Terms.
      </p>

      <div class="text-h5 text-weight-bold q-mb-md">11. DISPUTE RESOLUTION</div>
      <p class="q-mb-md">Informal Negotiations</p>
      <p class="q-mb-xl">
      ...
      <p class="q-mb-md">Binding Arbitration</p>
      <p class="q-mb-xl">
        ...
        arbitrators shall be one (1). The seat, or legal place, or arbitration shall be New York,
        NY. The language of the proceedings shall be English. The governing law of these Legal Terms
        shall be substantive law of the United States.
      </p>

      <p class="q-mb-md">Restrictions</p>
      <p class="q-mb-xl">
      ...
      <p class="q-mb-md">Exceptions to Informal Negotiations and Arbitration</p>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">12. CORRECTIONS</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">13. DISCLAIMER</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">14. LIMITATIONS OF LIABILITY</div>
      <p class="q-mb-xl">
        ...
        THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $100.00 USD. CERTAIN US STATE LAWS
      ...
      <div class="text-h5 text-weight-bold q-mb-md">15. INDEMNIFICATION</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">16. USER DATA</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">18. MISCELLANEOUS</div>
      <p class="q-mb-xl">
      ...
      <div class="text-h5 text-weight-bold q-mb-md">19. CONTACT US</div>
      <p class="q-mb-md">
      ...
      <p>
        ...
        Email: support@mybackyardusa.com
      </p>
    </div>
  </q-page>
</template>
...
<script setup>
// No setup needed for this static page
</script>
